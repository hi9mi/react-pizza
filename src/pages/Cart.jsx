...
// 		return pizzaItems[key].pizzaItems[0];
// 	});
...
// 								type={pizza.type}
// 								size={pizza.size}
// 								totalPrice={pizzaItems[pizza.id].totalPrice}
// 								totalCount={pizzaItems[pizza.id].pizzaItems.length}
...
function Cart() {
	...
	const onClickOrder = () => {
		console.log('ВАШ ЗАКАЗ', pizzaItems);
		alert('Ваш заказ будет в скором времени будет доставлен! :)');
	};
					...
					<div className='content__items'>
						{addedPizzas.map((obj) => (
							<CartItem
								...
								type={obj.type}
								size={obj.size}
								totalPrice={pizzaItems[obj.id].totalPrice}
								totalCount={pizzaItems[obj.id].pizzaItems.length}
								onRemove={onRemoveItem}
								onMinus={onMinusItem}
								onPlus={onPlusItem}
							/>
